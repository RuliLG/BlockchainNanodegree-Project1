...
class Blockchain {
    ...
    _addBlock(block) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                if (errors.length > 0) {
                    return reject('Oops! Seems like the chain is broken :O');
                }

                const previousBlockHash = this.height === -1 ? null : this.chain[this.height].hash;
    ...
    submitStar(address, message, signature, star) {
        return new Promise(async (resolve, reject) => {
            ...
            const block = new BlockClass.Block(body);
        ...
        return new Promise(async (resolve, reject) => {
            for (const block of this.chain) {
                try {
                    ...
                    // Generated by the genesis block
                    console.log(error);
                }
            }
        ...
        return new Promise(async (resolve, reject) => {
            ...
            for (const block of this.chain) {
                if (block.previousBlockHash !== previousBlockHash) {
                    return reject(`Chain broken at block #${block.height}`);
                }
